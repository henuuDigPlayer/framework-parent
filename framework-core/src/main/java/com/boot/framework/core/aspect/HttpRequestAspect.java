package com.boot.framework.core.aspect;

import com.boot.framework.common.bean.BaseResponse;
import com.boot.framework.common.exception.CodeException;
import com.boot.framework.common.util.ResponseUtil;
import com.boot.framework.common.util.ResultCode;
import com.boot.framework.common.util.constant.ConstantUtil;
import com.boot.framework.common.util.data.JsonUtil;
import com.boot.framework.common.util.data.StringUtil;
import com.boot.framework.common.holder.RequestHolder;
import com.boot.framework.common.util.http.HttpRequestUtil;
