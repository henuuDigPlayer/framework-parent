...
public class HttpRequestUtil {
     ...
     * 发送HttpPost请求 json
     *
     * @param url     String 格式：http://XXXXXX
     * @param params  map body参数
     * @param headers map 请求头参数 需要包含Content-Type请求类型
     * @return String
     */
     ...
     * @throws IOException
     */
    public static HttpURLConnection getConnection(String url, Map<String,
...
//        connection.setRequestProperty("Content-Type", contentType);
    ...
    private static String writeResponse(HttpURLConnection connection, String requestContent) throws IOException {
